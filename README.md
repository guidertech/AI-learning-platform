...
* **Nested Accordion FAQ System:** Toggling **Help Center & FAQ** in settings opens an inline list of questions, each with a plus/minus (+/-) toggle icon. Clicking a question dynamically expands/collapses the answer inline directly under it.
